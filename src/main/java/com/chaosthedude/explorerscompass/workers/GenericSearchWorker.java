...
public class GenericSearchWorker extends StructureSearchWorker<StructurePlacement> {
	...
	public GenericSearchWorker(ServerWorld level, PlayerEntity player, ItemStack stack, BlockPos startPos, StructurePlacement placement, List<Structure> structureSet) {
